...
function tvPopupAppTray(a,b) {
    ...
    if (movie.apps) {
        ...
        if (movie.apps.tvTimeID) {
            ...
            button.classList = 'video-app clickable'
            ...
            <div class="text button-text">TV Time</div>`
            tray.append(button)
        ...
        if (movie.apps.reelgoodLink) {
            ...
            <div class="spacer-x" style="--size: 8px;"></div>
            <div class="text button-text">Reelgood</div>`
            tray.append(button)
            tray.append(spacerElement(10))
        }
        if (movie.apps.imdbID) {
            ...
            <div class="spacer-x" style="--size: 8px;"></div>
            <div class="text button-text">IMDb</div>`
            tray.append(button)
            tray.append(spacerElement(10))
        }
        if (movie.apps.subReddit) {
            ...
            <div class="spacer-x" style="--size: 8px;"></div>
            <div class="text button-text">Reddit</div>`
            tray.append(button)
            tray.append(spacerElement(10))
        }
