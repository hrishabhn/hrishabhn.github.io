...
function tvHuluElement(a,b) {
    ...
    if (movie.info.date) {
        ...
        if (soon) {
            ...
            var dateHTML = `<div class="spacer-x" style="--size: 8px;"></div><p class="detail">New</p>`
        }
    ...
    <div class="info">
        <div class="more clickable-o" onclick="tvPopupShow(${a},${b})">MORE</div>
        <a class="icon clickable" target="_blank" ${htmlLink}>${iconData['play']}</a>
    </div>`
