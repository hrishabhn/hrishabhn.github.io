    ...
    content: [
        {
            ...
            render: function() {
                ...
                widget1.classList = 'widget subcol clickable fill-parent layer-1 card-shadow'
                widget1.innerHTML = `
                ...
                widget2.classList = 'widget subcol clickable fill-parent layer-1 card-shadow'
                ...
                widget3.classList = 'widget subcol clickable fill-parent layer-1 card-shadow'
                widget3.innerHTML = `
                ...
                widget4.classList = 'widget subcol clickable fill-parent layer-1 card-shadow'
                widget4.innerHTML = `
