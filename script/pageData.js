    ...
    content: [
        {
            ...
            render: function() {
                ...
                widget2.classList = 'widget subcol clickable fill-parent layer-1 card-shadow button-text'
                ...
                widget3.classList = 'widget subcol clickable fill-parent layer-1 card-shadow button-text'
                ...
                widget4.classList = 'widget subcol clickable fill-parent layer-1 card-shadow button-text'
                widget4.innerHTML = `
